...
```
```{r}
NumCluster=4 #Our analysis set the number of classes equal to four because we found that the process of adding or subtracting classes lowered the average silhouette width; in other words, the fit seemed worse when we used three or five.
